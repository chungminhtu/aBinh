<%@ Page Language="C#" Title="Danh sách Kiểm tra Đảng viên" AutoEventWireup="true" CodeFile="DanhMucKyLuat.aspx.cs" Inherits="DanhMucKyLuat" MasterPageFile="MasterPage.master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">

    <div class="header">
        <i class="fa fa-table"></i>&nbsp;&nbsp;DANH SÁCH KIỂM TRA ĐẢNG VIÊN
    </div>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="txtNgheNghiep" runat="Server" Width="250px" Height="25px">
                        ...
                        <asp:ListItem>Kiểm tra Đảng viên đã nghỉ hưu</asp:ListItem>
                        <asp:ListItem>Kiểm tra Đảng viên bị mất chức</asp:ListItem>
                    </asp:DropDownList>
                </td>
    ...
    <p></p>
    <div>
        <asp:GridView ID="GridKyLuat" runat="server" CellPadding="4"
            Width="100%"  OnRowCommand="GridKyLuat_RowCommand" OnPreRender="GridKyLuat_PreRender" OnRowCreated="GridKyLuat_OnRowCreated"
            ...
            <FooterStyle BackColor="#673AB7" ForeColor="White" Font-Bold="True" />
