<%@ Page Language="C#" Title="Thông tin Đảng viên" AutoEventWireup="true" CodeFile="ThemSuaDangVien.aspx.cs" Inherits="ThemSuaDangVien" MasterPageFile="MasterPage.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="Server">
    ...
    <div>
        <div class="back">
            <a href="DanhMucDangVien.aspx"><i class="fa fa-arrow-circle-left"></i>&nbsp;&nbsp;Quay lại danh sách Đảng viên</a>
        </div>
        <div class="message">
